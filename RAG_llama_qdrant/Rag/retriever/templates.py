...
default_template = """Answer the following question based on this context:
...
# Answer:"""
response_step_back_prompt = ChatPromptTemplate.from_template(response_prompt_template)
